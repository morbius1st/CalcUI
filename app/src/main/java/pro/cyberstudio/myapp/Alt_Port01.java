...
public class Alt_Port01 extends AppCompatActivity {
	...
	private static final int LAYOUT_ID = R.id.tbl_alt_port01;

	View alt_port01_layout;
	gLayoutListner gL;
...
//	private View landView = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_alt_port01);
...
//		initHistoryView(intent.getStringExtra(MainActivity.EXTRA_MESSAGE + "\nmessage being sent")) );
		...
		alt_port01_layout = findViewById(LAYOUT_ID);

		alt_port01_layout.getViewTreeObserver().addOnGlobalLayoutListener(gL);
	...
	class gLayoutListner implements ViewTreeObserver.OnGlobalLayoutListener {
		...
		public void onGlobalLayout() {
			...
			alt_port01_layout.getViewTreeObserver().removeOnGlobalLayoutListener(gL);
		}
	...
	private void updateTextSize() {
		...
		getView(R.id.button804).setOnClickListener(oclTest);
		getView(R.id.button805).setOnClickListener(oclTest);
